...
<html lang="en">
<head>
    <title>Code coverage report for lib/rest/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/rest</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { stripSlashes } = require('@feathersjs/commons');
...
function httpMethod (verb, uris) {
  return method =&gt; {
    Object.defineProperty(method, HTTP_METHOD, {
      ...
      configurable: true,
      writable: false,
      value: (Array.isArray(uris) ? <span class="branch-0 cbranch-no" title="branch not covered" >uris </span>: [uris])
        .reduce(
...
function getDefaultUri (path, methods, method) {
  return methods[method].indexOf('id') === -1
    ? <span class="branch-0 cbranch-no" title="branch not covered" >`/${path}/${method}`</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(routes)) {
        return [
          ...result,
