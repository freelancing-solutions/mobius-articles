...
<html lang="en">
<head>
    <title>Code coverage report for lib/rest/getHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/rest</a> getHandler.js
    </h1>
    <div class='clearfix'>
...
function getAllowedMethods (service, routes) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (routes) {
    return routes
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return Object.keys(methodMap)</span>
    .filter(<span class="fstat-no" title="function not covered" >me</span>thod =&gt; <span class="cstat-no" title="statement not covered" >typeof service[method] === 'function')</span>
    .map(<span class="fstat-no" title="function not covered" >me</span>thod =&gt; <span class="cstat-no" title="statement not covered" >methodMap[method])</span>
    // Filter out duplicates
    .filter(<span class="fstat-no" title="function not covered" >(v</span>alue, index, list) =&gt; <span class="cstat-no" title="statement not covered" >list.indexOf(value) === index)</span>;
}
&nbsp;
