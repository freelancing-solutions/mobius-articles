...
<html lang="en">
<head>
    <title>Code coverage report for src/routing.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> routing.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
      return this[ROUTER].lookup(stripSlashes('' + path) || <span class="branch-1 cbranch-no" title="branch not covered" >'/')</span>;
    }
  });
&nbsp;
