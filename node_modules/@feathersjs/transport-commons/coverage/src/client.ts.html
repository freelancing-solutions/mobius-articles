...
<html lang="en">
<head>
    <title>Code coverage report for src/client.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> client.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(options: ServiceOptions) {
    ...
    this.timeout = options.timeout || <span class="branch-1 cbranch-no" title="branch not covered" >5000;</span>
&nbsp;
...
&nbsp;
  find(params: Params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
    return this.send('find', params.query || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
  }
&nbsp;
...
&nbsp;
  ...
  off(name: string, ...args: any[]) {
    if (typeof this.connection.off === 'function') {
      ...
      // @ts-ignore
<span class="cstat-no" title="statement not covered" >      return this.removeAllListeners(name);</span>
    }
&nbsp;
    // @ts-ignore
<span class="cstat-no" title="statement not covered" >    return this.removeListener(name, ...args);</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
